...
const StatCard = ({ icon: Icon, label, value, color, change }: { icon: any; label: string; value: string; color: string; change?: string }) => (
  <div className="bg-background border border-border rounded-lg p-6 hover:shadow-md transition-shadow cursor-pointer">
...
const recentOrders = [
  { id: "#1234", customer: "Maria Silva", total: "R$199,90", status: "Entregue", date: "30/03/2026" },
  { id: "#1233", customer: "João Santos", total: "R$399,80", status: "Enviado", date: "29/03/2026" },
  { id: "#1232", customer: "Ana Costa", total: "R$199,90", status: "Processando", date: "29/03/2026" },
  { id: "#1231", customer: "Pedro Oliveira", total: "R$599,70", status: "Entregue", date: "28/03/2026" },
  { id: "#1230", customer: "Camila Souza", total: "R$249,90", status: "Enviado", date: "28/03/2026" },
];
...
const DashboardPanel = () => (
  <div className="space-y-6">
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      ...
      <StatCard icon={Package} label="Pedidos" value="28" color="bg-blue-50 text-blue-600" change="+5 novos" />
